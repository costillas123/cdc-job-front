  ...
  <Layout>
    <BRow>
        ...
        <BCard no-body id="emailList">
          ...
          <BCardHeader class="border-0">
            <BRow class="align-items-center gy-3">
              <BCol cols="sm">
                <h5 class="card-title mb-0">Settings | Announcements</h5>
              </BCol>
              <BCol sm="auto">
      ...
      <BModal
        v-model="isModalOpen"
        hide-footer
        :title="isEdit ? 'Edit New Announcement' : 'Add New Announcement'"
...
import {
  getSystemAnnounces,
  createSystemAnnounce,
  updateSystemAnnounce,
  deleteSystemAnnounce,
} from "@/api-request";
...
const handleSubmit = async () => {
  ...
  try {
    const response = editId.value
      ? await updateSystemAnnounce(editId.value, form.value)
      : await createSystemAnnounce(form.value);
...
const confirmDelete = async () => {
  ...
  try {
    ...
    const response = deleteSystemAnnounce(deleteItem.value.id);
