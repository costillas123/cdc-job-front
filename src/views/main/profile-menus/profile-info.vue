        ...
        <BCol>
          <div class="p-2">
            ...
            <p class="text-white text-opacity-75">
              {{
                currentUser?.address ? currentUser?.address : "No Address Found"
              }}
            </p>
        ...
        <div>
          ...
          >
            <div class="d-flex justify-content-end">
              <router-link to="/profile-setting" class="btn btn-success"
                    ...
                    <BCard no-body>
                      <BCardBody>
                        ...
                        <div class="d-flex flex-wrap gap-2 fs-15">
                          ...
                          <!-- ❌ No documents -->
                          <template v-else>
                            <span class="text-muted">No documents listed</span>
                          </template>
                        </div>
                      </BCardBody>
                    </BCard>
                        ...
                        <BCol cols="6" md="4">
                          <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                              ...
                              <h6 class="text-truncate mb-0">
                                {{
                                  currentUser?.job_seeker?.preferred_location ||
                                  "—"
                                }}
                              </h6>
                            </div>
              ...
              <BCard no-body class="bg-light">
                <BCardBody>
                  <h5 class="card-title mb-4">
                    <i class="ri-time-line align-bottom text-primary me-1"></i>
                    Job Experience
                  </h5>
                  ...
                  >
                    <div
                      v-for="(exp, index) in currentUser.job_seeker.experiences"
                      :key="exp.id || index"
                    >
...
import { formatLongDate, formatDateTime } from "@/helpers/useFormats";
...
const fetchAllData = async () => {
  try {
    const [userLogRes] = await Promise.all([
      getUserLogs({
        type: "user",
      }),
    ]);

    // Map results into label/value format
